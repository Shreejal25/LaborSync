...
import { getManagerRewards, deleteReward, updateReward } from '../../endpoints/api';
...
const ManagerRewardsView = () => {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      // Update the rewards list with the edited reward
...
{showEditModal && editingReward && (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div className="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-2xl">
      ...
      {/* Sidebar */}
      <div className="w-1/6 bg-white shadow-md flex flex-col p-4 font-['Poppins']">
